...
describe('limit', () => {
    ...
    testCasesForData([1, 2, 3])(
        'should only return the first number of values that were asked for when given a(n) %s',
        (type, dataSource) => {
    ...
    testCasesForData([1, 2, 3])(
        'should return a generator that does not emit any values if the amountToTake parameter is <= 0 when given a(n) %s',
        (type, datasource) => {
