...
describe('skipWhile', () => {
    ...
    testCasesForData([1, 2, 3, 4])(
        'should not emit any values until the predicate fails when given a(n) %s',
        (type, data) => {
    ...
    testCasesForData([1, 2, 3])(
        'should not emit any values if the predicate never fails when given a(n) %s',
        (type, data) => {
    ...
    testCasesForData([1, 2, 3, 4, 5])(
        'should emit all values if the predicate instantly fails when given a(n) %s',
        (type, data) => {
