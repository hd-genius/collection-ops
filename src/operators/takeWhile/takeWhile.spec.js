...
describe('takeWhile', () => {
    ...
    testCasesForData([1, 2, 3])(
        'should return an operation that stops emitting values once the predicate returns false when given a(n) %s',
        (type, data) => {
    ...
    testCasesForData([1, 8, 3, 4, 2])(
        'should not emit values after the predicate fails when given a(n) %s',
        (type, data) => {
